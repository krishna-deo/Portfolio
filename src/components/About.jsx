...
import imgMan from '../assets/man/aboutpic.jpeg';
        ...
        <div ref={textContainerRef} className="flex flex-col justify-center space-y-10">
          ...
          <div className="overflow-hidden">
            <h2 className="stagger-reveal text-5xl md:text-6xl font-bold tracking-tighter text-white font-sans leading-tight">
              The Dual <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-purple-500 font-serif italic pr-4">Expertise</span>
            </h2>
          </div>

          <div className="overflow-hidden">
            <p className="stagger-reveal text-lg md:text-xl text-gray-400 font-light leading-relaxed max-w-xl">
              Modern applications demand more than just good design — they demand security, performance, and resilience.As a Full-Stack Developer with a strong foundation in Cybersecurity, I bridge the gap between development and defense. I not only build systems, but also ensure they are protected against real-world threats.
            </p>
          </div>
          ...
          <div className="overflow-hidden mt-6">
            <blockquote className="stagger-reveal border-l-2 border-red-500/50 pl-6 py-2">
              <p className="text-xl md:text-2xl text-gray-200 font-serif italic">
                “Build Strong. Break Smart. Secure Everything..”
              </p>
            </blockquote>
          </div>
