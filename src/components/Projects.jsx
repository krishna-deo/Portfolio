      ...
      <div className="max-w-[90rem] mx-auto w-full relative z-10">
        ...
        <div ref={headerRef} className="mb-16 md:mb-24 flex flex-col md:flex-row md:items-end justify-between border-b border-white/10 pb-8">
          <div className="max-w-2xl">
            <h2 className="text-3xl md:text-4xl lg:text-[3.5rem] font-bold tracking-tighter text-white font-sans leading-none drop-shadow-lg mb-4">
            Projects Built with <span className="font-serif italic font-light opacity-80 text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-white pr-2">Precision</span>
          </h2>
          </div>
          <p className="text-gray-400 font-light tracking-wide text-base md:text-lg max-w-sm mt-6 md:mt-0 leading-relaxed md:text-right">
            Applications designed for performance, scalability, and security.
          </p>
        </div>
